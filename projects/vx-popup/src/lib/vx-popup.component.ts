...
export class VxPopupComponent {
  ...
  @Output() onDrag = new EventEmitter<DragStartEvent>();
  @Output() onResize = new EventEmitter<ResizeEvent>();
  ...
  @Input() set draggable(value: boolean) {
    if (value !== this._draggable) {
      this.emitChangedOption('draggable', value, this._draggable);
  ...
  @Input() set resizable(value: boolean) {
    if (value !== this._resizable) {
      this.emitChangedOption('resizable', value, this._resizable);
  ...
  private _draggable = default_popup_properties.draggable;
  private _resizable = default_popup_properties.resizable;
...
const default_popup_properties = {
  ...
  draggable: true, // Popup is draggable by default
  resizable: true, // Popup can be resized by default
