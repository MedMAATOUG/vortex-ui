...
import {
  ...
  VxButtonType,
  VxButtonClickEvent,
  VxButtonOptionChangedEvent,
  VxButtonContentReadyEvent,
  VxButtonHoverEvent,
  VxButtonDblClickEvent,
...
export class VxButtonComponent implements AfterViewInit {
  // Output events
  @Output() onClick = new EventEmitter<VxButtonClickEvent>();
  @Output() onDblClick = new EventEmitter<VxButtonDblClickEvent>();
  @Output() onHover = new EventEmitter<VxButtonHoverEvent>();
  @Output() onOptionChanged = new EventEmitter<VxButtonOptionChangedEvent>();
  @Output() onContentReady = new EventEmitter<VxButtonContentReadyEvent>();
