...
export class PopupFusionService {
  ...
  private popupsRef: {
    id: string;
    popupRef: ComponentRef<PopupFusionComponent>;
  }[] = [];
  ...
  openPopup(properties: VxPopupConfig): PopupFusionComponent {
    // Create the component dynamically with the correct injector
    const componentRef = createComponent(PopupFusionComponent, {
