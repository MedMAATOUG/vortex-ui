...
import {
  VxLoaderMode,
  VxLoaderContentReadyEvent,
  VxLoaderEndLoadingEvent,
  VxLoaderOptionChangedEvent,
  VxLoaderStartLoadingEvent,
  type VxLoderSize,
...
export class VxLoaderComponent {
  @Output() onStartLoading = new EventEmitter<VxLoaderStartLoadingEvent>();
  @Output() onEndLoading = new EventEmitter<VxLoaderEndLoadingEvent>();
  @Output() onOptionChanged = new EventEmitter<VxLoaderOptionChangedEvent>();
  @Input() onContentReady = new EventEmitter<VxLoaderContentReadyEvent>();
